          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-6">
                But if you feel called to give a little something, we've put together a small
                registry with some of our most wished-for items at Sining Spaces. Scan the QR 
                on this page or send an email to hello@reallygreatsite.com with the Registry 
                No. 12345 as the subject line for our updated gift list.
              </p>
            </div>
