...
const journeyPhotos: JourneyPhoto[] = [
	...
	{ image: demoImg2, location: 'Madrid', year: '2023', rotation: 2 },
	...
	return (
		<section className="bg-[#fbf7ee] px-0 md:px-4 py-12 md:py-20 lg:py-24">
			<div className="max-w-7xl mx-auto">
				...
				<div className="flex flex-nowrap md:flex-wrap justify-center items-start gap-0 md:gap-10 lg:gap-16 mb-16 md:mb-20 lg:mb-24">
				...
				{/* Second paragraph */}
				<div className="max-w-5xl md:max-w-6xl mx-auto mb-12 md:mb-16 lg:mb-20 pl-4 md:pl-0 text-left md:text-right md:pl-24 px-4 md:px-0">
					<p className="text-[#412d1d]/80 text-base md:text-lg font-hoangngan4 leading-relaxed">
				...
				<div className="flex flex-nowrap md:flex-wrap justify-center items-start gap-0 md:gap-10 lg:gap-16">
