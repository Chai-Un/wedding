...
export default function NgayNangVe() {
	...
	const photos = [
		{
			id: '1',
			src: 'gallery/ngaynangve/mievatho_NH0014.jpg',
			alt: 'Photo 1',
		},
		{
			id: '2',
			src: 'gallery/ngaynangve/mievatho_NH0056.jpg',
			alt: 'Photo 2',
		},
		{
			id: '3',
			src: 'gallery/ngaynangve/mievatho_NH0203.jpg',
			alt: 'Photo 3',
		},
		{
			id: '4',
			src: 'gallery/ngaynangve/mievatho_NH0214.jpg',
			alt: 'Photo 4',
		},
		{
			id: '5',
		...
		{
			id: '6',
			src: 'gallery/ngaynangve/mievatho_NH0428.jpg',
			alt: 'Photo 6',
		},
		{
			id: '7',
		...
		{
			id: '8',
			src: 'gallery/ngaynangve/mievatho_NH0545.jpg',
			alt: 'Photo 8',
		},
		{
			id: '9',
			src: 'gallery/ngaynangve/mievatho_NH0592.jpg',
			alt: 'Photo 9',
		},
		{
			id: '10',
			src: 'gallery/ngaynangve/mievatho_NH2421.jpg',
			alt: 'Photo 10',
		},
		{
			id: '11',
			src: 'gallery/ngaynangve/mievatho_NH2468.jpg',
			alt: 'Photo 11',
		},
		{
			id: '12',
			src: 'gallery/ngaynangve/mievatho_NH2572.jpg',
			alt: 'Photo 12',
		},
		{
			id: '13',
			src: 'gallery/ngaynangve/mievatho_NH2714.jpg',
			alt: 'Photo 13',
		},
		{
			id: '14',
			src: 'gallery/ngaynangve/mievatho_NH2760.jpg',
			alt: 'Photo 14',
		},
		{
			id: '15',
		...
		{
			id: '16',
			src: 'gallery/ngaynangve/mievatho_NH2930.jpg',
			alt: 'Photo 16',
		},
		{
			id: '17',
		...
		{
			id: '18',
			src: 'gallery/ngaynangve/mievatho_NH3135.jpg',
			alt: 'Photo 18',
		},
		{
			id: '19',
			src: 'gallery/ngaynangve/mievatho_NH3236.jpg',
			alt: 'Photo 19',
		},
		{
			id: '20',
			src: 'gallery/ngaynangve/mievatho_NH3279.jpg',
			alt: 'Photo 20',
		},
		{
			id: '21',
			src: 'gallery/ngaynangve/mievatho_NH3312.jpg',
			alt: 'Photo 21',
		},
		{
			id: '22',
			src: 'gallery/ngaynangve/mievatho_NH3341.jpg',
			alt: 'Photo 22',
		},
		{
			id: '23',
			src: 'gallery/ngaynangve/mievatho_NH3466.jpg',
			alt: 'Photo 23',
		},
		{
			id: '24',
			src: 'gallery/ngaynangve/mievatho_NH3549.jpg',
			alt: 'Photo 24',
		},
		{
			id: '25',
			src: 'gallery/ngaynangve/mievatho_NH3644.jpg',
			alt: 'Photo 25',
		},
		{
			id: '26',
			src: 'gallery/ngaynangve/mievatho_NH3736.jpg',
			alt: 'Photo 26',
		},
	];
				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="mb-1 md:mb-2">
						...
						<div className="mb-1 md:mb-2">
							<div
								...
								className="aspect-video overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer"
							>
								<ResponsiveImage
									src={photos[3].src}
									alt={photos[3].alt}
						...
						{/* Row 3: portrait | landscape (2fr) | portrait */}
						<div
						...
						>
							<div
								...
								className="flex-1 overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer"
							>
								<ResponsiveImage
									src={photos[4].src}
									alt={photos[4].alt}
							...
							<div
								...
								className="flex-2 overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer"
							>
								<ResponsiveImage
									src={photos[5].src}
									alt={photos[5].alt}
					...
					<div className="mb-1 md:mb-2">
						...
						*/}
						...
						>
							{/* Col 1, Row 1+2 */}
							<div onClick={() => handlePhotoClick(18)} className="overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer" style={{ gridColumn: '1', gridRow: '1 / 3' }}>
							...
							<div onClick={() => handlePhotoClick(20)} className="overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer" style={{ gridColumn: '2', gridRow: '1 / 5' }}>
							...
							<div onClick={() => handlePhotoClick(21)} className="overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer" style={{ gridColumn: '3', gridRow: '1 / 4' }}>
								<ResponsiveImage src={photos[21].src} alt={photos[21].alt} className="absolute inset-0 w-full h-full object-cover" sizes="33vw" />
								<div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors" />
							</div>
							{/* Col 1, Row 3+4 */}
							<div onClick={() => handlePhotoClick(19)} className="overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer" style={{ gridColumn: '1', gridRow: '3 / 5' }}>
							...
							<div onClick={() => handlePhotoClick(25)} className="overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer" style={{ gridColumn: '3', gridRow: '4 / 6' }}>
							...
							<div onClick={() => handlePhotoClick(22)} className="overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer" style={{ gridColumn: '1', gridRow: '5' }}>
							...
							<div className="flex gap-1 md:gap-2" style={{ gridColumn: '2', gridRow: '5' }}>
								<div onClick={() => handlePhotoClick(23)} className="flex-1 overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer">
									<ResponsiveImage src={photos[23].src} alt={photos[23].alt} className="absolute inset-0 w-full h-full object-cover" sizes="16vw" />
									<div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors" />
								</div>
								<div onClick={() => handlePhotoClick(24)} className="flex-1 overflow-hidden shadow-sm hover:shadow-md transition-shadow relative group cursor-pointer">
									<ResponsiveImage src={photos[24].src} alt={photos[24].alt} className="absolute inset-0 w-full h-full object-cover" sizes="16vw" />
									<div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors" />
								</div>
							</div>
						</div>
